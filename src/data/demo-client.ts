...
export function seedState(): DemoState {
  ...
  return {
    version: 3,
    users: [
      { id: 'usr_1', username: 'demo', name: 'Aylin Mammadova', avatar: 'images/founders/aysel-mammadova.webp', email: 'demo@studentstartupcommunity.local', title: 'Product Strategist', company: 'Orbit Labs', industry: 'Technology', location: 'Baku, Azerbaijan', skills: 'Product Strategy, Community Growth, Research', about: 'I help ambitious teams turn community insight into focused products and durable growth.', availability: 'Open to collaborate', website: 'https://example.com', role: 'admin', roles: ['student', 'founder', 'platform_admin'], activeRole: 'platform_admin', verificationStatus: 'verified' },
      { id: 'usr_2', username: 'nihat', name: 'Nihat Abbasov', avatar: 'images/founders/reshad-quliyev.webp', email: 'nihat@studentstartupcommunity.local', title: 'Founder · GreenStack', company: 'GreenStack', industry: 'Climate', location: 'Baku, Azerbaijan', skills: 'Python, APIs, Climate Data', about: 'Building useful climate data products.', availability: 'Mentoring', website: '', role: 'member', roles: ['student'], activeRole: 'student', verificationStatus: 'verified' },
      { id: 'usr_3', username: 'leyla', name: 'Leyla Karim', avatar: 'images/founders/leyla-aliyeva.webp', email: 'leyla@studentstartupcommunity.local', title: 'Product Designer', company: 'North Studio', industry: 'Design', location: 'Remote', skills: 'Design Systems, UX Research, Prototyping', about: 'Designing calm and trustworthy product experiences.', availability: 'Open to projects', website: '', role: 'member', roles: ['student'], activeRole: 'student', verificationStatus: 'verified' },
      { id: 'usr_4', username: 'kamran', name: 'Kamran Vali', avatar: 'images/avatars/kamran-vali.webp', email: 'kamran@studentstartupcommunity.local', title: 'AI Engineer', company: 'ModelWorks', industry: 'AI', location: 'Remote', skills: 'Python, LLM Apps, MLOps', about: 'Applied AI engineer shipping production systems.', availability: 'Open to collaborate', website: '', role: 'member', roles: ['student'], activeRole: 'student', verificationStatus: 'verified' },
      { id: 'usr_5', username: 'tarlan', name: 'Tarlan Yusifzade', avatar: 'images/avatars/tarlan-yusifzade.webp', email: 'tarlan@studentstartupcommunity.local', title: 'Mentor · ex-VC', company: 'Independent', industry: 'Venture', location: 'Baku, Azerbaijan', skills: 'Fundraising, Go-to-market, Strategy', about: 'Operator-turned-investor. I mentor founders on validation and raise readiness.', availability: 'Office hours weekly', website: '', role: 'member', roles: ['mentor'], activeRole: 'mentor', verificationStatus: 'verified' },
      { id: 'usr_6', username: 'nargiz', name: 'Nargiz Rahim', avatar: 'images/avatars/nargiz-rahim.webp', email: 'nargiz@studentstartupcommunity.local', title: 'Founder · MediMatch', company: 'MediMatch', industry: 'Health', location: 'Baku, Azerbaijan', skills: 'Operations, Health, Strategy', about: 'Connecting students with affordable verified medical professionals.', availability: 'Open to collaborate', website: '', role: 'member', roles: ['student'], activeRole: 'student', verificationStatus: 'verified' },
      { id: 'usr_7', username: 'elvin', name: 'Elvin Safar', avatar: 'images/avatars/elvin-safar.webp', email: 'elvin@studentstartupcommunity.local', title: 'Founder · EduFlow', company: 'EduFlow', industry: 'EdTech', location: 'Remote', skills: 'ML, Product, Pedagogy', about: 'Turning lecture recordings into adaptive practice questions.', availability: 'Looking for a designer', website: '', role: 'member', roles: ['student'], activeRole: 'student', verificationStatus: 'verified' },
      ...
      { id: 'usr_17', username: 'program-operator', name: 'Naila Aliyeva', email: 'program.operator@studentstartupcommunity.local', title: 'University Program Operator', company: 'Illustrative innovation office', industry: 'Education', location: 'Baku, Azerbaijan', skills: 'Cohort Operations, Verification, Outcome Reporting', about: 'Illustrative operator profile for reviewing applications, evidence and cohort progress.', availability: 'Demo persona', website: '', role: 'member', roles: ['program_manager'], activeRole: 'program_manager', verificationStatus: 'verified' },
      { id: 'usr_18', username: 'partner-operator', name: 'Orkhan Mammadli', email: 'partner.operator@studentstartupcommunity.local', title: 'Ecosystem Partner Operator', company: 'Illustrative partner organization', industry: 'Ecosystem Operations', location: 'Baku, Azerbaijan', skills: 'Commitments, Programs, Contributions, Reporting', about: 'Illustrative operator profile for partner commitments, contributions and outcome review.', availability: 'Demo persona', website: '', role: 'member', roles: ['partner_admin'], activeRole: 'partner_admin', verificationStatus: 'verified' },
      { id: 'usr_19', username: 'platform-operator', name: 'Amina Safarova', email: 'platform.operator@studentstartupcommunity.local', title: 'SSC Platform Administrator', company: 'SSC demo workspace', industry: 'Platform Operations', location: 'Baku, Azerbaijan', skills: 'Governance, Access Control, Audit, Demo Data', about: 'Illustrative platform administrator for governance, audit and access-control review.', availability: 'Demo persona', website: '', role: 'admin', roles: ['platform_admin'], activeRole: 'platform_admin', verificationStatus: 'verified' },
    ],
    passwords: {
      ...
      usr_17: 'demo123', usr_18: 'demo123', usr_19: 'demo123',
    },
    posts: [
      { id: 'pst_1', authorId: 'usr_2', content: 'GreenStack crossed 1,000 active users on our campus energy tracker this week. Two faculties piloting, 18% energy reduction on average. On to the next milestone.', type: 'Milestone', kind: 'milestone', tags: ['climate', 'growth', 'mvp'], media: ['images/feed/greenstack-dashboard.webp'], link: { title: 'GreenStack — Q2 campus impact report', subtitle: '1,000+ active users · 18% avg energy reduction · 2 faculties', url: 'greenstack.io/impact' }, commentsList: [{ id: 'cmt_1', authorId: 'usr_5', text: 'Strong traction. Let’s talk raise-readiness — book office hours.', createdAt: ago(40) }], createdAt: ago(60), reactions: 312, comments: 18, reposts: 24, liked: true, saved: false },
      ...
      { id: 'pst_4', authorId: 'usr_7', content: 'EduFlow beta is live — adaptive practice questions generated from your lecture recordings. 340 students signed up in week one. Looking for a product designer to partner with.', type: 'Launch', kind: 'launch', tags: ['edtech', 'launch', 'design'], media: ['images/feed/eduflow-product.webp'], link: { title: 'EduFlow beta', subtitle: 'Lecture recordings → adaptive practice · 340 sign-ups', url: 'eduflow.app' }, commentsList: [{ id: 'cmt_4', authorId: 'usr_3', text: 'Sent you a DM — would love to scope the design role.', createdAt: ago(500) }], createdAt: ago(540), reactions: 421, comments: 29, reposts: 36, liked: true, saved: false },
      { id: 'pst_11', authorId: 'usr_2', content: 'GreenStack and Baku Engineering University are starting a semester-long campus pilot. Facilities teams will validate our weekly savings recommendations across three buildings, with the results shared at SSC Demo Day.', type: 'Partnership', kind: 'partnership', tags: ['partnership', 'university-pilot', 'climate'], commentsList: [{ id: 'cmt_6', authorId: 'usr_8', text: 'This is exactly the kind of evidence investors need to see before a seed conversation.', createdAt: ago(570) }], createdAt: ago(610), reactions: 267, comments: 21, reposts: 31, liked: false, saved: true },
      { id: 'pst_12', authorId: 'usr_1', content: 'Thirty student builders joined today’s Product Validation Sprint. Teams left with one measurable assumption, a five-interview plan, and a mentor checkpoint for next week. The energy in the room felt very real.', type: 'Event', kind: 'event', tags: ['ssc-community', 'validation', 'workshop'], media: ['images/feed/ssc-founder-workshop.webp'], commentsList: [{ id: 'cmt_7', authorId: 'usr_7', text: 'The interview-plan exercise immediately sharpened our beta feedback questions.', createdAt: ago(640) }], createdAt: ago(660), reactions: 348, comments: 37, reposts: 29, liked: true, saved: false },
    ...
    nextIds: {
      user: 17, post: 13, comment: 8, job: 9, conversation: 6, message: 9,
