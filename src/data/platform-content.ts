...
export const mentors: MentorData[] = [
  ...
  { id: 'mnt_7', name: 'Samir Rustamli', title: 'Mentor · Engineering Leadership', expertise: ['Backend', 'Architecture', 'Hiring'], company: 'Caspian Cloud', rating: 4.8, sessions: 33, availability: 'Bi-weekly', focusStage: 'MVP → Pilot', bio: 'Engineering leader helping student teams scope reliable systems and make their first technical hires.', status: 'active' },
  { id: 'mnt_8', name: 'Nermin Jafarova', title: 'Mentor · Marketplaces', expertise: ['Marketplaces', 'Growth', 'Trust & Safety'], company: 'Independent', rating: 4.7, sessions: 29, availability: 'Weekly', focusStage: 'Validation → Revenue', bio: 'Marketplace operator focused on liquidity, trusted transactions, and repeatable campus growth.', status: 'active' },
]
